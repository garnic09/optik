...
public class ControllerArmazon {
    // Método que inserta un objeto Armazon en la base de datos y devuelve su id

    public int insertar(Armazon armazon) throws Exception {
// Paso 1: Definir la consulta a la base de datos
        ...
        // Paso 2: Preparar la llamada al procedure con los parámetros necesarios
...
// Paso 3: Registrar los parámetros de salida del procedure
...
// Paso 5: Obtener los valores de los parámetros de salida del procedure
        idProductoG = cstmt.getInt(11);
        idArmazonG = cstmt.getInt(12);
        codigoBarrasG = cstmt.getString(13);

// Paso 6: Actualizar el objeto Armazon con los valores obtenidos de la base de datos
...
// Paso 7: Devolver el id del objeto Armazon insertado
        return idArmazonG;
