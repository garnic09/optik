 ...
 * @author garni
 */
public class VentaProsupuestoL {
    PresupuestoL presupuestoLente;
    int cantidad;
    float precioUnitario;
    float descuento;

    public VentaProsupuestoL() {
    }

    public VentaProsupuestoL(PresupuestoL presupuestoLente, int cantidad, float precioUnitario, float descuento) {
